...
1. [mahskill2024-*.pdf.en.txt](flow/writeTxt_/output/): Orders in Marathi.

2. [mahskill2024-*.pdf.mr.txt](flow/writeTxt_/output/): Orders in English.
...
```
git clone https://github.com/orgpedia/mahskill2024.git
```
